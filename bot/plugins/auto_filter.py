...
async def auto_filter(bot, update):
    ...
    if filters: 
        ...
        text=f"𝗦𝗲𝗮𝗿𝗰𝗵 ♝ google.com ♝ \n\n𝗙𝗶𝗻𝗱 𝘁𝗵𝗲 𝗖𝗼𝗿𝗿𝗲𝗰𝘁 𝗦𝗽𝗲𝗹𝗹𝗶𝗻𝗴 𝗼𝗳 \n\n 𝚈𝙾𝚄𝚁 𝚁𝙴𝚀𝚄𝙴𝚂𝚃: <code>{query}</code> \n\n 𝗮𝗻𝗱 𝗬𝗲𝗮𝗿 𝙊𝙛 𝙧𝙚𝙡𝙚𝙖𝙨𝙚. \n\n⚠️𝗧𝘆𝗽𝗲 𝘁𝗵𝗮𝘁 𝗶𝗻 𝗚𝗿𝗼𝘂𝗽 𝘁𝗼 𝗴𝗲𝘁 𝘁𝗵𝗲 𝗙𝗶𝗹𝗲𝘀 (𝗖𝗢𝗥𝗥𝗘𝗖𝗧 𝗠𝗢𝗩𝗜𝗘 𝗡𝗔𝗠𝗘 𝗔𝗦 𝗦𝗔𝗠𝗘 𝗜𝗡 𝗚𝗢𝗢𝗚𝗟𝗘)\n\n𝐈𝐅 𝐘𝐎𝐔 𝐒𝐓𝐈𝐋𝐋 𝐃𝐈𝐃𝐍𝐓 𝐆𝐄𝐓 𝐓𝐇𝐄 𝐑𝐄𝐒𝐔𝐋𝐓𝐒,тнє ƒιℓє ιѕ ησт αναιℓαвℓє ☺️",
        parse_mode="html",
