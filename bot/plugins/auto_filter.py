...
async def auto_filter(bot, update):
    ...
    if filters: 
        ...
        for filter in filters: # iterating through each files
         ...
         text=f''' <a href="https://telegra.ph/file/3f9cedc2012141e3a7f0a.jpg">⬞</a>𝗙𝗶𝗻𝗱 𝘁𝗵𝗲 𝗖𝗼𝗿𝗿𝗲𝗰𝘁 𝗦𝗽𝗲𝗹𝗹𝗶𝗻𝗴 𝗼𝗳\n<b>{query}</b> \n\n⚠️𝗧𝘆𝗽𝗲 𝘁𝗵𝗮𝘁 𝗶𝗻 𝗚𝗿𝗼𝘂𝗽 𝘁𝗼 𝗴𝗲𝘁 𝘁𝗵𝗲 𝗙𝗶𝗹𝗲𝘀 (𝐂𝐎𝐏𝐘 𝐏𝐀𝐒𝐓𝐄 𝐓𝐇𝐄 𝐍𝐀𝐌𝐄 𝐅𝐑𝐎𝐌 𝐆𝐎𝐎𝐆𝐋𝐄🙃) ''', 
